...
buttons = [button(400,50,(xmax/2,ymax/2-70),"START",pixel_font,32,colors.red,colors.unSelectedButtonColor,runGame),
           button(400,50,(xmax/2,ymax/2),"SCOREBOARD",pixel_font,32,colors.red,colors.unSelectedButtonColor,lambda: deathMenu(dM_run)),
           button(400,50,(xmax/2,ymax/2+70),"QUIT",pixel_font,32,colors.red,colors.unSelectedButtonColor,pg.K_ESCAPE)]
